...
register(
        id='ABBIRB140MoveItEnv-v0',
        entry_point='abb_irb140_reacher.robot_env.abb_irb140_moveit:ABBIRB140MoveItEnv',
        max_episode_steps=10000,
    )

class ABBIRB140MoveItEnv(robot_BasicEnv.RobotBasicEnv):
    """
    ...
    def __init__(self):
        ...
        * MoveIt! : MoveIt! action server is used to send the joint positions to the robot.
        ...
        rospy.set_param('/ABB_IRB140_Reacher/current_robot_num', num_robot)
        ...
        """
        super(ABBIRB140MoveItEnv, self).__init__(   launch_gazebo=False, spawn_robot=True, 
        ...
        ros_launch.ros_launch_from_pkg("abb_irb140_reacher","irb140_moveit.launch", args=["namespace:="+str(self.namespace)])
        ...
        """
        rospy.loginfo("Finished Init of ABBIRB140MoveIt Env")
    ...
    #--------------------------------------------#
    #  Methods created for the Abb IRB140 Robot  #
...
class MoveABB(object):
    ...
    def __init__(self):
        ...
        self.group_name = "abb_irb140_arm"
