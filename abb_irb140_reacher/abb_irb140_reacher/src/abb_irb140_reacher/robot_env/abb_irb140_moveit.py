...
class ABBIRB140MoveItEnv(robot_BasicEnv.RobotBasicEnv):
    ...
    def __init__(self):
        ...
        * MoveIt! : MoveIt! action server is used to send the joint positions to the robot.
        ...
        self.controller_list=["joint_state_controller","arm140_controller"]
        ...
        ros_launch.ros_launch_from_pkg("abb_irb140_reacher","moveit_init.launch", args=["namespace:="+str(self.namespace)])
