...
register(
        id='KobukiDynamicEnv-v2',
        entry_point='kobuki_maze_rl.task_env.kobuki_dynamic_v2:KobukiDynamicEnv',
...
class KobukiDynamicEnv(kobuki_lidar_env.KobukiLIDAREnv):
    ...
    def __init__(self):
        ...
        """
        action_space_low  = np.array([-0.3, -0.3]) # linear velocity, angular velocity
