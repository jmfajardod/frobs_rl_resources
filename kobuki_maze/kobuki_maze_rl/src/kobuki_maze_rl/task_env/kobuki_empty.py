...
class KobukiEmptyEnv(kobuki_lidar_env.KobukiLIDAREnv):
    ...
    def __init__(self):
        ...
        rospy.logwarn("Observation Space Low  P->>>" + str(observ_space_low))
        rospy.logwarn("Observation Space High P->>>" + str(observ_space_high))
        ...
        rospy.logwarn("Observation Space Low  A->>>" + str(self.observation_space.low))
        rospy.logwarn("Observation Space High A->>>" + str(self.observation_space.high))
