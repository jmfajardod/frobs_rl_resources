...
class PosPublisher:
    ...
    def get_params(self):
        ...
        if self.pos_dynamic:
            self.x_max_amplitude = rospy.get_param('ur5/pos_dynamic_params/x_max_amplitude')
            self.y_max_amplitude = rospy.get_param('ur5/pos_dynamic_params/y_max_amplitude')
            self.z_max_amplitude = rospy.get_param('ur5/pos_dynamic_params/z_max_amplitude')

            self.x_max_freq = rospy.get_param('ur5/pos_dynamic_params/x_max_freq')
            self.y_max_freq = rospy.get_param('ur5/pos_dynamic_params/y_max_freq')
            self.z_max_freq = rospy.get_param('ur5/pos_dynamic_params/z_max_freq')
